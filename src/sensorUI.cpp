...
void ui()
{
    ...
    {
        system ("clear");
        std::cout << "1: Connect to sensor circuit" << std::endl;
        std::cout << "2: Safety control" << std::endl;
        std::cout << "3: Sensor control" << std::endl;
        std::cout << "4: System readout" << std::endl;
        std::cout << "5: Mapping services" << std::endl;
        std::cout << "6: Demining services" << std::endl;
        ...
        switch(selection)
        {
         ...
         case 2:
            ...
            case 4:
                ...
                break;
            case 5:
                // Run mapping services user interface aka mappingui
